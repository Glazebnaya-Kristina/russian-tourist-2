...
!function (e, t) {
   ...
   var i = function () {
      ...
      return n(r, e), r.prototype.renderSegHtml = function (e, r) {
         var n, i, o = this.context, s = o.view, l = o.options, a = e.eventRange, d = a.def, c = a.ui, h = d.allDay,
            p = s.computeEventDraggable(d, c), u = h && e.isStart && s.computeEventStartResizable(d, c),
            f = h && e.isEnd && s.computeEventEndResizable(d, c), g = this.getSegClasses(e, p, u || f, r),
            m = t.cssToStr(this.getSkinCss(c)), y = "";
      ...
      return n(r, e), r.prototype.attachSegs = function (e, t) {
         ...
         var n, i, o, s, l, a, d, c = this.dayGrid, h = c.colCnt, p = c.isRtl, u = this.buildSegLevels(r),
            f = Math.max(1, u.length), g = document.createElement("tbody"), m = [], y = [], v = [];
         ...
         for (n = 0; n < f; n++) {
            if (i = u[n], o = 0, s = document.createElement("tr"), m.push([]), y.push([]), v.push([]), i) for (l = 0; l < i.length; l++) {
               a = i[l];
               var w = p ? h - 1 - a.lastCol : a.firstCol, S = p ? h - 1 - a.firstCol : a.lastCol;
               for (b(w), d = t.createElement("td", {className: "fc-event-container"}, a.el), w !== S ? d.colSpan = S - w + 1 : v[n][o] = d; o <= S;) y[n][o] = d, m[n][o] = a, o++;
               s.appendChild(d)
            }
            b(h);
         ...
         return {row: e, tbodyEl: g, cellMatrix: y, segMatrix: m, segLevels: u, segs: r}
      }, r.prototype.buildSegLevels = function (e) {
         var t, r, n, i = this.dayGrid, o = i.isRtl, s = i.colCnt, l = [];
   ...
   var h = function (e) {
      ...
      function r(r, n) {
         var i = e.call(this, r, n) || this, o = i.eventRenderer = new f(i),
      ...
      return n(r, e), r.prototype.render = function (e) {
         ...
         var r = this.theme, n = this.dateEnv.format(e, t.createFormatter(this.opt("dayPopoverFormat")));
   ...
   var y = t.createFormatter({day: "numeric"}), v = t.createFormatter({week: "numeric"}), b = function (e) {
      function r(r, n, i) {
         ...
         var s = o.eventRenderer = new a(o), l = o.fillRenderer = new p(o);
      ...
      return n(r, e), r.prototype.render = function (e) {
         ...
         var n, i, o = this.view, s = this.dateEnv, l = this.rowCnt, a = this.colCnt, d = "";
         for (n = 0; n < l; n++) d += this.renderDayRowHtml(n, r);
         for (this.el.innerHTML = d, this.rowEls = t.findElements(this.el, ".fc-row"), this.cellEls = t.findElements(this.el, ".fc-day, .fc-disabled-day"), this.isRtl && this.cellEls.reverse(), this.rowPositions = new t.PositionCache(this.el, this.rowEls, !1, !0), this.colPositions = new t.PositionCache(this.el, this.cellEls.slice(0, a), !0, !1), n = 0; n < l; n++) for (i = 0; i < a; i++) this.publiclyTrigger("dayRender", [{
         ...
         var r, n, i = this.view, o = this.dateEnv, s = "",
            l = t.rangeContainsMarker(this.props.dateProfile.activeRange, e), a = this.getIsDayNumbersVisible() && l;
         return a || this.renderProps.cellWeekNumbersVisible ? ((r = t.getDayClasses(e, this.props.dateProfile, this.context)).unshift("fc-day-top"), this.renderProps.cellWeekNumbersVisible && (n = o.weekDow), s += '<td class="' + r.join(" ") + '"' + (l ? ' data-date="' + o.formatIso(e, {omitTime: !0}) + '"' : "") + ">", this.renderProps.cellWeekNumbersVisible && e.getUTCDay() === n && (s += t.buildGotoAnchorHtml(i, {
            date: e,
            type: "week"
         }, {class: "fc-week-number"}, o.format(e, v))), a && (s += t.buildGotoAnchorHtml(i, e, {class: "fc-day-number"}, o.format(e, y))), s += "</td>") : "<td></td>"
      }, r.prototype.updateSize = function (e) {
         var t = this.fillRenderer, r = this.eventRenderer, n = this.mirrorRenderer;
         ...
         var n, i, o, s, l, a, d, c, h, p, u, f, g, m, y, v = this, b = this.colCnt, w = this.isRtl,
            S = this.eventRenderer.rowStructs[e], C = [], E = 0, R = function (n) {
         ...
         if (r && r < S.segLevels.length) {
            for (n = S.segLevels[r - 1], i = S.cellMatrix, (o = t.findChildren(S.tbodyEl).slice(r)).forEach(function (e) {
               ...
               l = n[s];
               var H = w ? b - 1 - l.lastCol : l.firstCol, D = w ? b - 1 - l.firstCol : l.lastCol;
         ...
         var i = this, o = this.view, s = this.dateEnv, l = t.createElement("a", {className: "fc-more"});
         return l.innerText = this.getMoreLinkText(n.length), l.addEventListener("click", function (t) {
            var l = i.opt("eventLimitClick"), a = i.isRtl ? i.colCnt - r - 1 : r, d = i.props.cells[e][a].date,
         ...
         var o, l, a = this, d = this.calendar, c = this.view, h = this.theme, p = this.isRtl ? this.colCnt - r - 1 : r,
            f = n.parentNode;
   ...
   }(t.DateComponent), w = t.createFormatter({week: "numeric"}), S = function (e) {
      function r(r, n, i, o) {
         ...
         var a, d = t.createElement("div", {className: "fc-day-grid"});
   ...
   var C = function (e) {
      function t(t, r) {
         ...
         return n.slicer = new E, n.dayGrid = r, t.calendar.registerInteractiveComponent(n, {el: n.dayGrid.el}), n
      }
   ...
   e.AbstractDayGridView = S, e.DayBgRow = g, e.DayGrid = b, e.DayGridSlicer = E, e.DayGridView = R, e.SimpleDayGrid = C, e.buildBasicDayTable = H, e.default = D, Object.defineProperty(e, "__esModule", {value: !0})
});